...
public class DependencyGraphTest
{
    ...
    /// <summary>
    /// Testing for multiple ordered pairs
    /// </summary>
    [TestMethod()]
    public void MultiplePairingTest()
    {
        DependencyGraph t = new DependencyGraph();
        t.AddDependency("x", "y");
        t.AddDependency("a", "b");
    ...
    /// <summary>
    /// Testing for duplicate ordered pairs
    /// </summary>
    [TestMethod()]
    public void DuplicatePairingTest()
    {
        DependencyGraph t = new DependencyGraph();
        t.AddDependency("x", "y");
        t.AddDependency("x", "y");
    ...
    /// <summary>
    /// Empty graph has no dependents
    /// </summary>
    [TestMethod()]
    public void EmptyNoDependents()
    {
        DependencyGraph t = new DependencyGraph();
    ...
    /// <summary>
    /// Empty graph has no dependees
    /// </summary>
    [TestMethod()]
    public void EmptyNoDependees()
    {
        DependencyGraph t = new DependencyGraph();
    ...
    public void ReplaceThenEnumerate()
    {
        ...
        IEnumerator<string> e = t.GetDependees("a").GetEnumerator(); 
        Assert.IsFalse(e.MoveNext()); //nothing has a as a dependent
