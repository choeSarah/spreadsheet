...
public class DependencyGraphTest
{
    ...
    [TestMethod(), Timeout(2000)]
    [TestCategory("4")]
    public void TestEmptyNumDependees()
    {
        DependencyGraph t = new DependencyGraph();
    ...
    [TestMethod(), Timeout(2000)]
    [TestCategory("10")]
    public void TestAddRemoveNumDependeesEmpty()
    {
        DependencyGraph t = new DependencyGraph();
        t.AddDependency("x", "y");
        Assert.AreEqual(1, t.NumDependees("y"));
        t.RemoveDependency("x", "y");
        Assert.AreEqual(0, t.NumDependees("y"));
    }
    ...
    [TestMethod(), Timeout(2000)]
    [TestCategory("19")]
    public void TestSimpleNumDependees()
    {
        DependencyGraph t = new DependencyGraph();
        t.AddDependency("a", "b");
        t.AddDependency("a", "c");
    ...
    [TestMethod(), Timeout(2000)]
    [TestCategory("24")]
    public void TestDuplicatesNumDependees()
    {
        DependencyGraph t = new DependencyGraph();
        t.AddDependency("a", "b");
        t.AddDependency("a", "c");
    ...
    [TestMethod(), Timeout(2000)]
    [TestCategory("29")]
    public void TestAddRemoveNumDependees()
    {
        DependencyGraph t = new DependencyGraph();
        t.AddDependency("x", "y");
        t.AddDependency("a", "b");
    ...
    [TestMethod(), Timeout(2000)]
    [TestCategory("35")]
    public void TestComplexReplaceNumDependees()
    {
        DependencyGraph t = new DependencyGraph();
        t.AddDependency("x", "b");
        t.AddDependency("a", "z");
